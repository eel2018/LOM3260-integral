...
class Everything:
    ...
    #*******    ROTULOS  ***** 
        ...
        resp.grid(row=4,column=2,sticky='W',padx=10,pady=10)
    ...
    #******  BOTAO  *********
        ...
        BQ.grid(row=5,columnspan=7,padx=10,pady=10)
    ...
    def Mostra_valor(self):
        ...
        b = float(self.B.get())
        f = self.F.get()
        valor = integ.integral(f,a,b)
        self.Atualiza_grafico(f,a,b)
        msg.showinfo('Valor da integral', 'O valor da integral é %F' % valor)
